...
class SuppliersRSuppliersConnector {
    ...
    public function index() {
		...
		if($firewallCls->verifyUser())
		{
			...
			$data['view_url'] = $defCls->genURL('suppliers/r_suppliers/view/');
			...
			require_once _HTML."suppliers/r_suppliers.php";
	...
	public function view()
	{
		...
		if($firewallCls->verifyUser())
		{
			...
			$this_required_file = _HTML.'suppliers/r_suppliers_view.php';
