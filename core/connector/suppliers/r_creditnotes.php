...
class SuppliersRCreditnotesConnector {
    ...
    public function index() {
		...
		if($firewallCls->verifyUser())
		{
			...
			$data['view_url'] = $defCls->genURL('suppliers/r_creditnotes/view/');
			...
			require_once _HTML."suppliers/r_creditnotes.php";
	...
	public function view()
	{
		...
		if($firewallCls->verifyUser())
		{
			...
			$data['title_tag'] = 'Supplier Credit Note Report | '.$dateCls->todayDate('d-m-Y H:i:s').' | '.$data['companyName'];
			...
			$getRows = $SuppliersTransactionsCreditnotesQuery->gets($sql);
			...
			$this_required_file = _HTML.'suppliers/r_creditnotes_view.php';
