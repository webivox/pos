...
class SuppliersROutstandingConnector {
    ...
    public function index() {
		...
		if($firewallCls->verifyUser())
		{
			...
			$data['titleTag'] 	= 'Supplier Outstanding Report | '.$defCls->master('companyName');
	...
	public function view()
	{
		...
		if($firewallCls->verifyUser())
		{
			...
			$data['title_tag'] = 'Supplier Outstanding Report | '.$dateCls->todayDate('d-m-Y H:i:s').' | '.$data['companyName'];
