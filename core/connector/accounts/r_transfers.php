...
class AccountsRTransfersConnector {
    ...
    public function index() {
		...
		if($firewallCls->verifyUser())
		{
			...
			$data['titleTag'] 	= 'Account Transfer Report | '.$defCls->master('companyName');
	...
	public function view()
	{
		...
		if($firewallCls->verifyUser())
		{
			...
			if(isset($_REQUEST['search_account_from'])){ $search_account_from=$db->request('search_account_from'); }
			else{ $search_account_from=''; }
			
			if(isset($_REQUEST['search_account_to'])){ $search_account_to=$db->request('search_account_to'); }
