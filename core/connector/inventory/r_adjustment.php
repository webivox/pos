...
class InventoryRAdjustmentConnector {
    ...
    public function index() {
		...
		if($firewallCls->verifyUser())
		{
			...
			$data['titleTag'] 	= 'Stock Adjustment Report | '.$defCls->master('companyName');
	...
	public function view()
	{
		...
		if($firewallCls->verifyUser())
		{
			...
			$data['title_tag'] = 'Inventory Adjustment Report | '.$dateCls->todayDate('d-m-Y H:i:s').' | '.$data['companyName'];
