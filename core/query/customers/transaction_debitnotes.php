<?php
class CustomersTransactionsDebitnotesQuery {
	
	private $tableName="customers_debit_notes";
	private $itemTableName="customers_debit_note_items";
...
$CustomersTransactionsDebitnotesQuery = new CustomersTransactionsDebitnotesQuery;
?>