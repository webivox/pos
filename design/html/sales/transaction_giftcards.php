<div id="right">
	...
	<div id="filter_head">
        ...
        <a class="open_popup_form btn btn-primary" id="filter_head_create" data-url="<?php echo $data['create_url']; ?>" data-width="420" data-height="380">Create New</a>
    ...
    <div id="filter_content">
        ...
        <div class="col_1">
            ...
            <input type="text" name="search_no" id="search_no" placeholder="Name">
