...
<div id="report_cont">
    ...
    <table class="table">
        ...
        <tr class="dgrey">
            ...
            <td colspan="17" id="sales_report_head"><strong>Return Notes</strong></td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $r['added_date']; ?></td>
                <td><?php echo $r['invoice_no']; ?></td>
                <td colspan="7"><?php echo $r['customer']; ?></td>
                <td class="text-right"><?php echo $r['total_value']; ?></td>
                <td class="text-right"><?php echo $r['cost']; ?></td>
                <td class="text-right"><?php echo $r['profit']; ?></td>
                <td class="text-right"><?php echo $r['profit_percentage']; ?></td>
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td colspan="9">Total Returns</td>
                <td class="text-right"><?php echo $data['totalReturnTotal']; ?></td>
                <td class="text-right"><?php echo $data['totalReturnCost']; ?></td>
                <td class="text-right"><?php echo $data['totalReturnProfit']; ?></td>
                <td class="text-right"><?php echo $data['profitReturnPercentage']; ?></td>
                <td colspan="4"></td>
            ...
            <tr>
                ...
                <td colspan="9">Total After Return</td>
                <td class="text-right"><?php echo $data['totalAfterReturn']; ?></td>
                <td class="text-right"><?php echo $data['totalReturnCost']; ?></td>
                <td class="text-right"><?php echo $data['totalReturnProfit']; ?></td>
                <td class="text-right"><?php echo $data['profitAfterReturnPercentage']; ?></td>
                <td colspan="4"></td>
