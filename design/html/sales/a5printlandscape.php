...
<link href="<?php echo _CSS; ?>a5printlandscape.css" rel="stylesheet" type="text/css">
...
<div id="maindiv">
    ...
    <div class="invoice_item_line_row">
        ...
        <div class="invoice_item_det_item"><?php echo $defCls->showText($InventoryMasterItemsQuery->data($ii['item_id'],'name')); ?> <?php if($ii['unique_no']){ echo '|'.$ii['unique_no']; } ?></div>
            	...
            	<td>
                	...
                	<table class="table">
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="text-align:left; padding:10px;" valign="top">
