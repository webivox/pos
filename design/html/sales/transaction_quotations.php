<div id="right">
    ...
    <div id="filter_content">
        ...
        <div class="col_3">
            ...
            <input type="text" name="search_no" id="search_no" placeholder="No" value="QTE-">
        ...
        <div class="col_3">
            <label for="search_customer_id">Customer</label>
            <input type="text" name="search_customer_id_txt" id="search_customer_id_txt" data-setid="search_customer_id" placeholder="" class="customerAjax">
        ...
        <div class="col_3">
            <label for="search_location_id">Location</label>
            <input type="text" name="search_location_id_txt" id="search_location_id_txt" data-setid="search_location_id" placeholder="" class="locationAjax">
            <input type="hidden" id="search_location_id" name="search_location_id" />
        </div>
...
<script type="text/javascript" src="<?php echo _JS; ?>core/sales_quotations.js"></script>