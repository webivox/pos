    	...
    	<thead>
            ...
            <tr>
                ...
                <td colspan="4" id="invoice_head">
                    ...
                    <p><?php echo $data['return_print_header']; ?></p>
            	...
            	<td id="invoice_head_second" colspan="4">
                	...
                	<table class="table">
                        ...
                        <tr>
                            ...
                            <td class="invoice_head_second_ll">RETURN NO</td>
        ...
        <tbody>  
                ...
                <td colspan="4" id="invoice_item_head">
                    ...
                    <table class="table">
                        ...
                        <tbody>
							...
							$i=0;
							$subTotal = 0;
							foreach($data['return_items'] as $ii)
							{
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td class="invoice_item_price"><?php echo $defCls->money($ii['price']); ?></td>
                                <td class="invoice_item_qty"><?php echo $defCls->num($ii['qty']); ?></td>
                                <td class="invoice_item_amount"><?php echo $defCls->money($ii['total']); ?></td>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td colspan="4" id="cash_bl_l">USED AMOUNT</td>
                                <td id="cash_bl_r"><?php echo $defCls->money($data['used_value']); ?></td>
            ...
            <tr>
            	...
            	<td colspan="4" id="total_saving">
                    ...
                    BALANCE AMOUNT: <?php echo $defCls->money($data['balance_value']); ?>
            ...
            <tr>
            	...
            	<td colspan="4" id="barcode">
                
            	<img src="<?php echo _FONTS; ?>barcode.php?text=<?php echo $data['return_no']; ?>">
            ...
            <tr>
            	...
            	<td colspan="4" id="footer">
						<?php echo $data['return_print_footer']; ?>
