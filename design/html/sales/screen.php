...
<div id="center_cart">
    ...
    <div id="center_cart_r_icso">
        ...
        <div id="item_search">
            ...
            <input type="text" id="itemSearchInput" placeholder="Barcode/Item Name" autofocus>
        ...
        <div id="customer">
            ...
            <input type="text" id="customerSearchInput" placeholder="Customer Name" value="<?php echo $data['customer_name']; ?>">
    ...
    <div id="center_cart_r_items_total">
        ...
        <div id="center_cart_r_items_total_l">
                ...
                <table class="table">
                	...
                	<tr>
                    	...
                    	<td id="gsdtd">
                            ...
                            <input type="text" id="discount_value" placeholder="0.00" value="<?php echo $data['discount_value']; ?>">
                        </td>
            ...
            <textarea id="comments"><?php echo $data['comments']; ?></textarea>
    ...
    <div id="right_payment">
    	...
    	<div id="right_payment_quick">
        	...
        	<div id="right_payment_quick_return" class="right_payment_quick_cls">
            	...
            	<table class="table">
                	...
                	<tr>
                    	...
                    	<td><input type="text" id="right_payment_quick_return_no" placeholder="Return No."></td>
        	...
        	<div id="right_payment_quick_giftcard" class="right_payment_quick_cls">
            	...
            	<table class="table">
                	...
                	<tr>
                    	...
                    	<td><input type="text" id="right_payment_quick_giftcard_no" placeholder="Gift Card No."></td>
        	...
        	<div id="right_payment_quick_credit" class="right_payment_quick_cls">
            	...
            	<input type="text" id="right_payment_quick_credit_date" class="dateField" placeholder="Due Date">
        	...
        	<div id="right_payment_quick_cheque" class="right_payment_quick_cls">
            	...
            	<input type="text" id="right_payment_quick_cheque_bank" placeholder="Bank Code">
            	<input type="text" id="right_payment_quick_cheque_date" class="dateField" placeholder="Date">
            	<input type="text" id="right_payment_quick_cheque_no" placeholder="Cheque No">
        ...
        <div id="right_payment_add_pmnt">
        	...
        	<input type="text" id="paymentAmt" placeholder="0.00">
