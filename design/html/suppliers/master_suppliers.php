<div id="right">
	...
	<div id="filter_head">
        ...
        <a class="open_popup_form btn btn-primary" id="filter_head_create" data-url="<?php echo $data['create_url']; ?>" data-width="1024" data-height="490">Create New</a>
    ...
    <div id="filter_content">
        ...
        <div class="col_4">
            ...
            <label for="search_contact_person">Contact Person</label>
            <input type="text" name="search_contact_person" id="search_contact_person" placeholder="Contact Person">
        ...
        <div class="col_4">
            ...
            <input type="text" name="search_phone_number" id="search_phone_number" placeholder="Phone Number">
