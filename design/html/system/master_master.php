<div id="right">
	...
	<div id="filter_head">
        ...
        <a class="open_popup_form btn btn-primary" id="filter_head_create" data-url="<?php echo $data['create_url']; ?>" data-width="350" data-height="300">Create New</a>
    ...
    <div id="filter_content">
        ...
        <div class="col_1">
            ...
            <input type="text" name="search_key" id="search_key" placeholder="Key">
