<div id="right">
    ...
    <div id="filter_content">
        ...
        <div class="col_3">
            ...
            <input type="text" name="search_cheque_no" id="search_cheque_no" placeholder="Cheque No">
        ...
        <div class="col_3">
            ...
            <label for="search_cheque_type">Type</label>
            <select name="search_cheque_type" id="search_cheque_type">
...
<script type="text/javascript" src="<?php echo _JS; ?>core/cheque.js"></script>