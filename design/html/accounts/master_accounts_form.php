...
<div id="popup_form_in_form_in">  
    ...
    <div class="col_1">
        ...
        <label for="payment_method">Is payment method?</label>
        <select name="payment_method" id="payment_method">
        
        	<option value="1" <?php if($data['payment_method']==1){ echo 'selected'; } ?>>Yes</option>
        	<option value="0" <?php if($data['payment_method']==0){ echo 'selected'; } ?>>No</option>
