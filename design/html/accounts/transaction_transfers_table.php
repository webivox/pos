<div class="divDataTable">
	...
	<div class="divDataTableIn">
        ...
        {
        ?>
        <div class="row rowhover" id="rowLine<?php echo $cat['transfer_id']; ?>">
            ...
            <div class="col-10 action">
                ...
                <a data-url="<?php echo $cat['deleteURL']; ?>" data-id="<?php echo $cat['transfer_id']; ?>" class="btn btn-danger delete"><i class="fa-light fa-trash-can"></i></a>
