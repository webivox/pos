<div id="right">
    ...
    <div id="filter_content">
        ...
        <div class="col_4">
            ...
            <label for="search_account_from">Account From</label>
            <select name="search_account_from" id="search_account_from">
        ...
        <div class="col_4">
            ...
            <label for="search_account_to">Account To</label>
            <select name="search_account_to" id="search_account_to">
