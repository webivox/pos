<div id="right">
    ...
    <div id="filter_content">
        ...
        <div class="col_4">
            ...
            <label for="search_payee">Payee</label>
            <select name="search_payee" id="search_payee">
                
                <option value="">- Choose -</option>
                <?php
                foreach($data['payee_list'] as $cat){
                ?>
                <option value="<?php echo $cat['payee_id']; ?>"><?php echo $cat['name']; ?></option>
                <?php } ?>
        ...
        <div class="col_4">
            ...
            <label for="search_expences_type">Expences Type</label>
            <select name="search_expences_type" id="search_expences_type">
                
                <option value="">- Choose -</option>
                <?php
                foreach($data['expences_type_list'] as $cat){
                ?>
                <option value="<?php echo $cat['expences_type_id']; ?>"><?php echo $cat['name']; ?></option>
                <?php } ?>
