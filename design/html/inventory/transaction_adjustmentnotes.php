<div id="right">
    ...
    <div id="filter_content">
        ...
        <div class="col_3">
            ...
            <input type="text" name="search_no" id="search_no" placeholder="No" value="ADJ-">
...
<script type="text/javascript" src="<?php echo _JS; ?>core/inventory_adjustment.js"></script>