<div id="right">
	...
	<div id="filter_head">
        ...
        <a class="open_popup_form btn btn-primary" id="filter_head_create" data-url="<?php echo $data['create_url']; ?>" data-width="420" data-height="375">Create New</a>
    ...
    <div id="filter_content">
        ...
        <div class="col_3">
            ...
            <label for="search_parent_category">Parent Category</label>
            <select name="search_parent_category" id="search_parent_category" class="autofocus">
