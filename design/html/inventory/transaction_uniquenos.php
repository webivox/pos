<div id="right">
    ...
    <div id="filter_content">
        ...
        <div class="col_3">
            ...
            <input type="text" id="search_item_name" name="search_item_name" class="itemAjax" data-focus="search_unique_no" data-setid="search_item_name_id" />
            <input type="hidden" id="search_item_name_id" name="search_item_name_id" />

        </div>
        
        <div class="col_3">
        
            <label for="search_unique_no">Unique No</label>
            <input type="text" name="search_unique_no" id="search_unique_no" placeholder="Unique No">
