    ...
    <table class="table">
        ...
        <tr>
            ...
            <td colspan="8" id="sales_report_head">
            	...
            	<h1>Inventory Receiving Note</h1>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>RN No</td>
                <td><?php echo $data['receiving_note_no']; ?></td>
            ...
            <tr>
                ...
                <td>Details</td>
                <td colspan="5"><?php echo $data['remarks']; ?></td>
                	...
                	<table class="table">
                    	...
                    	<tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right"><?php echo $defCls->num($il['qty']); ?></td>
                                <td class="text-right"><?php echo $defCls->num($il['price']); ?></td>
                                <td class="text-right"><?php echo $defCls->num($il['buying_price']); ?></td>
                                <td class="text-right"><?php echo $defCls->num($il['discount']); ?></td>
                                <td class="text-right"><?php echo $defCls->num($il['final_price']); ?></td>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td colspan="2"></td>
                                <td class="text-right"><?php echo $defCls->num($data['totalQty']); ?></td>
                                <td class="text-right"></td>
                                <td class="text-right">Total Save</td>
                                <td class="text-right"><?php echo $defCls->num($data['totalSave']); ?></td>
                                <td class="text-right">Total</td>
                                <td class="text-right"><?php echo $defCls->num($data['totalTotal']); ?></td>
