<div class="divDataTable">
	...
	<div class="divDataTableIn">
        ...
        foreach($data['debitnotes'] as $cat)
        {
        ?>
        <div class="row rowhover" id="rowLine<?php echo $cat['debit_note_id']; ?>">
            ...
            <div class="col-10 action">
                ...
                <a data-url="<?php echo $cat['deleteURL']; ?>" data-id="<?php echo $cat['debit_note_id']; ?>" class="btn btn-danger delete"><i class="fa-light fa-trash-can"></i></a>
            
            </div>
            <div class="col-10"><?php echo $cat['debit_note_no']; ?></div>
