<div id="right">
    ...
    <div id="filter_content">
        ...
        <div class="col_4">
            ...
            <input type="text" name="search_no" id="search_no" placeholder="No" value="CSETT-">
        ...
        <div class="col_4">
            ...
            <label for="search_customer_id_txt">Customer</label>
...
<script type="text/javascript" src="<?php echo _JS; ?>core/customers_rn.js"></script>