<div class="divDataTable">
	...
	<div class="divDataTableIn">
         ...
         <div class="hrow">
            ...
            <div class="col-10">Phone Number</div>
            <div class="col-10">Customer Group</div>
        ...
        foreach($data['customers'] as $cat)
        {
        ?>
        <div class="row rowhover" id="rowLine<?php echo $cat['customer_id']; ?>">
            <div class="col-10 action">
                ...
                <a data-url="<?php echo $cat['deleteURL']; ?>" data-id="<?php echo $cat['customer_id']; ?>" class="btn btn-danger delete"><i class="fa-light fa-trash-can"></i></a>
            
            </div>
        
            <div class="col-60"><?php echo $cat['name']; ?></div>
            <div class="col-10"><?php echo $cat['phone_number']; ?></div>
            <div class="col-10"><?php echo $cat['customer_group']; ?></div>
