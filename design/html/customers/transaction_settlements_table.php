<div class="divDataTable">
	...
	<div class="divDataTableIn">
        ...
        foreach($data['settlements'] as $cat)
        {
        ?>
        <div class="row rowhover" id="rowLine<?php echo $cat['settlement_id']; ?>">
            ...
            <div class="col-10 action">
                ...
                <a data-url="<?php echo $cat['deleteURL']; ?>" data-id="<?php echo $cat['settlement_id']; ?>" class="btn btn-danger delete"><i class="fa-light fa-trash-can"></i></a>
            
            </div>
            <div class="col-10"><?php echo $cat['settlement_no']; ?></div>
